...
import '@/v1/styles/Music.css'
import { playlist2 } from "@/v1/data/songs";
...
export default function Music() {
  ...
  const resetPlay = (index) => {
    ...
    audioRef.current = new Audio(songs[index].file);
    setProgress(0);
    if (!messageShown) setShowMessage(false);
    ...
    <div className="music-container">
      <div className="music-player flex flex-col gap-1">
        ...
        <div className="music-controls">
          ...
          <button onClick={togglePlayPause} className="play-button" type="button">
